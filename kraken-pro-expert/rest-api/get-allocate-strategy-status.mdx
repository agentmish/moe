---
title: "get allocate strategy status"
description: "Learn about get allocate strategy status in the Kraken Pro REST API."
sidebarTitle: "get allocate strategy status"
icon: "book"
tag: "NEW"
---
Spot REST APIEarnGet Allocation Status
Get Allocation Status
POST
https://api.kraken.com/0/private/Earn/AllocateStatus
